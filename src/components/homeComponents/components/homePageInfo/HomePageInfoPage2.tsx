  ...
  return (
    <div className="p-2">
      <div className="max-w-7xl mx-auto flex flex-col gap-4">
        {/* First Box */}
        <div className="w-full bg-gray-100 p-6 mb-4 rounded-lg shadow-md flex flex-col md:flex-row justify-center items-center gap-8">
          <div className="md:w-1/3">
            <p className="text-lg text-blue-800 font-bold text-center pl-4 ">
              For Founders &
              <br />
              Entrepreneurs
            </p>
          ...
          <div className="md:w-2/3">
            <ul className="list-disc list-inside text-gray-800 text-lg leading-relaxed">
              <li className="text-lg text-gray-700 leading-relaxed pl-4">

...
const HomePageSigin = ({
  ...
  return (
    <div className=" p-2 mt-8 md:ml-6">
      <div className="max-w-7xl mx-auto flex md:flex-row flex-col-reverse ">
          ...
          <div className="mt-6 bg-white rounded-xl">
            ...
            <div className="mt-6">
              ...
              >
                ...
                <button
                  type="submit"
                  className="bg-blue-400 p-2 rounded-lg w-full "
                >
                  Login
                </button>
              </form>
        ...
        <div className="hidden md:w-1/2 md:flex justify-center items-center pl-8 ">
          <Image
            src="/rightImageHome.png"
            width={500}
            height={500}
